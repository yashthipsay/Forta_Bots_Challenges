...
export const BOT_UPDATE_EVENT = "function _agentUpdate(uint256 agentId, string newMetadata, uint256[] newChainIds)";

export const BOT_DEPLOYED_ADDRESS = "0x61447385B019187daa48e91c55c02AF1F1f3F863";
