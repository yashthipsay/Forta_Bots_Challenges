...
import { ASSET_INFO, CONFIGURATOR_PROXY, SET_GOVERNOR, USDC_TOKEN } from './constants';
  ...
  const mockAssetTokenAddress = createAddress("0x10957")
    ...
    it("should return single finding for single event occurence", async() => {
        ...
        const metadata = {
            ...
            'Collateral Asset - Collateral-1': '0x0000000000000000000000000000000000001247',
            'Collateral Asset - Collateral-2': '0x0000000000000000000000000000000000012567',
            'Collateral Asset - Collateral-3': '0x0000000000000000000000000000000000001289',
            'Collateral Asset - Collateral-4': '0x0000000000000000000000000000000000001290'
          };
    ...
    it("should return 0 findings for multiple non-governance events", async () => {
        ...
        nonGovEvents.forEach(eventSignature => {
          txEvent.addEventLog(
            ...
            [createAddress("0x12345"), createAddress("0x67890"), 1000]
          );
        });
